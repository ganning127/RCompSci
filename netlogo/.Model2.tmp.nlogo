;; Ganning Xu
breed [cat cats ] ;; different breeds of turtles
breed [ dog dogs ]
...
to setup-turtles
  ...
  set-default-shape cat "cat"
  set-default-shape dog "dog"
  create-cat num * 0.66 ;; create some cats
  create-dog num * 0.34 ;; create some dogs
...
to go
  ...
  tick ;; adds oen to the tick counter
end
@#$#@#$#@
GRAPHICS-WINDOW
210

...
Today I finished my presentation for SNCURCS. It is now on Canva.

\section{Week of November 21, 2022}
\subsection{Monday, November 21, 2022}
No progress today. I've finished my research poster and my presentation for SNCURCS. I'll probably practice that later. I've been working on my final projects for my other classes, and my UC applications all of today.

\subsection{Tuesday, November 22, 2022}
Today I researched current WhatsApp moderation techniques, and realized that they have absolutely no moderation on any type of dangerous messages.  I think this builds a better case about why our model is needed. Additionally, I ran a hate speech model on our dataset to see how well a pre-trained hate speech model detects provocative sentences. Needless to say, it sucked, as shown in Figure \ref{fig:hs}.

\begin{figure}[!hbt]
    \centering
    \includegraphics[scale=0.4]{images/hs.png}
    \caption{hate speech model run on provocative sentence dataset}
    \label{fig:hs}
\end{figure}

\subsection{Wednesday, November 23, 2022}
No progress today, I have been working on my UC application all day.

\subsection{Thursday, November 24, 2022}
No progress today, it is Thanksgiving.

\subsection{Friday, November 25, 2022}
Today I finished revising my sections of the RCompSci manual, and I also added a couple of pop-ins here and there throughout the Guide. I also looked over the revisions on the canva covers by melody and gave my feedback.

\subsection{Saturday, November 26, 2022}
No progress today, I have been swarmed with math mod work. I'm also not really sure how to run the fear speech model on our dataset, but I let Vaibhav know so he could assist me in it.

\subsection{Sunday, November 27, 2022}
No progress today. I moved back into NCSSM, and the school WIFI is not working anymore for me. I can't even access my college applications now...

\subsection{Monday, November 28, 2022}
Today I finalized and revised my sections on the RCompSci guide.

\subsection{Tuesday, November 29, 2022}
Today I went through and added more graphics to the RCompSci guide. I think it's pretty much almost there.

\subsection{Wednesday, November 30, 2022}
No progress today. We've finished the RCompSci guide and I had a swim meet today so I had to miss class. Additionally, I've made it a goal of mine to keep updating my RCompSci notebook until the very last day of class. I want this to be a complete project.

\subsection{Thursday, December 1, 2022}
Today was the last day of RCompSci! We've finished our RCompSci guide and it was honestly really fun. We also took a group photo!!!! I'm really really proud of myself for finishing this class and if you're reading this, Mr. Gotwals, thank you so much for everything :O

\subsection{Friday, December 2, 2022}
Today I finished creating my slide deck and I also created an interactive DEMO for provocative sentence detection for SNCURCS.

\subsection{Saturday, December 3, 2022}
Today I presented my research project at SNCURCS! It was a really fun expereince being able to share my project with others, and especially walking around and seeing the projects of others was really fascinating. I also saw that many fields are gradually turning to be more computational in nature, with many bio projects that use code.

Also, at today's presentation, two people said that I did a really great job with my research and that made me really happy :O
